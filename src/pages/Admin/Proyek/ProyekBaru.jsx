        ...
        <AuthGuard>
            ...
            <div className="w-full h-auto bg-color-grey px-28 py-12">
                ...
                <div className="w-full justify-between items-center flex mt-3">
                    <h1 className="font-semibold text-3xl">Buat Proyek Baru</h1>
                </div>
                <section>
                    <div className="max-h-full w-full bg-color-white mt-5 p-5 rounded-md">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-base font-medium text-gray-700 dark:text-gray-200">Nama Proyek <span className="text-color-red p-3 font-bold text-base">*</span></label>
                            <input
                            type="text"
                            name="name"
                            value={formData.name}
                        ...
                        <div className="w-full flex justify-start gap-3">
                            <div className="w-full">
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200">Lokasi kecamatan <span className="text-color-red p-3 font-bold text-base">*</span></label>
                                <select name="sektorCSR" id="sektorCSR" placeholder="Pilih Sektor CSR" className="block w-full px-4 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                                    <option value="">1</option>
                                    <option value="">2</option>
                                    <option value="">3</option>
                            ...
                            <div className="w-full">
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200">Tanggal Awal <span className="text-color-red p-3 font-bold text-base">*</span></label>
                                <input
                                type="date"
                                name="tanggalAwal"
                                // value={}
                            ...
                            <div className="w-full">
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200">Tanggal Akhir <span className="text-color-red p-3 font-bold text-base">*</span></label>
                                <input
                                type="date"
                                name="tanggalAkhir"
                                // value={}
